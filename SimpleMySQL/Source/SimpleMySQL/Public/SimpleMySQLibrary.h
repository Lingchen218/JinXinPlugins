...
public:
	...
	*/
	...
	static bool QueryLinkStmt(USimpleMysqlObject *Object, const FString& SQL, const TArray<FSimpleMysqlQueryStmt>& InQueryStmtParam, FSimpleMysqlQueryStmtResult &OutResult, FString& ErrMesg);
