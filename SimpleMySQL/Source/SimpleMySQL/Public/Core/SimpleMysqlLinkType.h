...
USTRUCT(BlueprintType)
struct SIMPLEMYSQL_API FSimpleMysqlQueryStmtResult
{
	GENERATED_USTRUCT_BODY()

	FSimpleMysqlQueryStmtResult()
		:InsertId(INDEX_NONE)
		, AffectedRows(INDEX_NONE)
		, PreparedStatementID(INDEX_NONE)
	{}

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "SimpleMySQL|Result")
	int64 InsertId;
