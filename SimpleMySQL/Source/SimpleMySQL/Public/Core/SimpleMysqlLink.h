...
public:
	...
	*/
	 ...
	 * Return whether the query is successful.
	*/
	bool QueryLinkStmt(const FString& SQL, const TArray<FSimpleMysqlQueryStmt>& InQueryStmtParam, FSimpleMysqlQueryStmtResult& OutResult, FString& ErrMesg);
...
public:
	...
	*/
	 ...
	 * Return whether the query is successful.
	*/
	bool ExecuteStmt(FSimpleMysqlQueryStmtResult& OutResult,FString& ErrMesg);
